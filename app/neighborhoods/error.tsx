...
export default function NeighborhoodsError({
  error,
  reset,
}: {
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <h1 className="text-2xl font-display font-bold text-brand-dark mb-3">
          Neighborhoods temporarily unavailable
        </h1>
        <p className="text-brand-dark/70 mb-6">
          We couldn&apos;t load neighborhood data right now. Please try again in a moment.
        </p>
        <button
          onClick={reset}
