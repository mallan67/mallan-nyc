      ...
      <main className="pt-20 py-16">
        <div className="max-w-sm mx-auto px-4">
          <div className="glass-card rounded-3xl p-8 sm:p-10">
            ...
            {/* Title */}
            <h1 className="text-2xl font-display font-semibold text-center mb-1">Register / Sign In</h1>
            <p className="text-brand-dark/50 text-center text-xs mb-6">
              For agents, buyers, renters, sellers &amp; landlords
            </p>

            {/* Social Auth — compact icon row */}
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[11px] text-brand-dark/35 font-medium uppercase tracking-wider">or continue with email</span>
              <div className="flex-1 h-px bg-black/8" />
            </div>
            ...
            <form className="space-y-3.5" onSubmit={handleSubmit}>
              <div>
                <input
                  ...
                  className="w-full rounded-xl px-4 py-2.5 bg-white/60 ring-1 ring-black/8 focus:outline-none focus:ring-2 focus:ring-brand-gold/30 text-sm"
              ...
              {error && (
                <div className="p-2.5 rounded-xl bg-red-50 text-red-700 text-xs text-center">
                  {error}
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-brand-dark text-white py-2.5 rounded-xl hover:bg-brand-dark/90 transition-colors text-sm font-medium disabled:opacity-50 cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full text-xs text-brand-gold hover:underline py-1.5 min-h-[44px] flex items-center justify-end"
              >
                Forgot password?
              </button>
            </form>
            ...
            {/* Forgot Password */}
            {showForgot && (
              <div className="mt-2 p-4 bg-gray-50/50 rounded-xl">
                <p className="text-sm font-medium mb-2.5">Reset your password</p>
                <form onSubmit={handleForgotPassword} className="space-y-2.5">
                  ...
                  />
                  {forgotMessage && (
                    <p className={`text-xs ${forgotMessage.includes('error') ? 'text-red-600' : 'text-green-600'}`}>
                      {forgotMessage}
                    </p>
                  )}
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-brand-gold text-white py-2.5 rounded-xl hover:bg-brand-gold/90 transition-colors text-xs font-medium disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2.5 text-xs text-brand-dark/60 hover:text-brand-dark rounded-xl ring-1 ring-black/8"
                    >
                      Cancel
                    </button>
                  </div>
            ...
            <div className="mt-5 pt-5 border-t border-black/5 text-center">
              <p className="text-brand-dark/50 text-xs mb-3">New here?</p>
              <Link
                href="/sign-up"
                className="inline-block w-full px-5 py-2.5 ring-1 ring-brand-dark/20 text-brand-dark rounded-xl hover:bg-black/3 transition-colors text-sm font-medium"
              >
                Create Account
              </Link>
            </div>
