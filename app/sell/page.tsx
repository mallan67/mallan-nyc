  ...
  return (
    <div className="min-h-screen bg-[#FEFEFE] font-sans">
      ...
      <main>
        ...
        {/* ═══════════════════════════════════════════════
            4b. WHAT YOUR CMA INCLUDES
            ═══════════════════════════════════════════════ */}
        <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#F8F7F4]">
          <div className="max-w-[1440px] mx-auto">
            <div className="text-center mb-12 md:mb-16">
              <p className="text-brand-gold-deep text-[13px] font-medium tracking-[0.2em] uppercase mb-3 gold-glow-text">Your Report</p>
              ...
              <p className="mt-4 text-brand-dark/95 text-[15px] font-light max-w-2xl mx-auto leading-relaxed">
                A Comparative Market Analysis is the foundation of every successful sale. Here is what you will receive.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Recent sales of similar properties in your neighborhood, including sale price, price per square foot, and days on market.',
                  icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
                },
                {
                  title: 'Active Competition',
                  description: 'Currently listed properties competing for the same buyers, so you understand where your property stands in the market.',
                  icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z',
                },
                {
                  title: 'Price Range',
                  description: 'A recommended listing price range based on the data, your property condition, and current market momentum.',
                  icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                },
                {
                  title: 'Market Trends',
                  description: 'Neighborhood-level data on price trends, inventory levels, and average days on market to inform your timing.',
                  icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6',
                },
                {
                  title: 'Net Proceeds Estimate',
                  description: 'An estimate of your net proceeds after closing costs, transfer taxes, and other seller expenses.',
                  icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z',
                },
                {
                  title: 'Strategic Recommendations',
                  description: 'Personalized advice on staging, timing, and pricing strategy tailored to your property and goals.',
                  icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z',
                },
              ].map((item) => (
                <div key={item.title} className="glass-card rounded-2xl p-6">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center mb-4" style={{ background: 'linear-gradient(135deg, rgba(184,134,11,0.12), rgba(184,134,11,0.04))' }}>
                    <svg className="w-5 h-5 text-brand-gold-deep" fill="none" viewBox="0 0 24 24" stroke="currentColor">
