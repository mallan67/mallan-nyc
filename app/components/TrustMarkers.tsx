    ...
    <section className="px-6 md:px-12 lg:px-20 py-20 md:py-32">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="mt-3 text-brand-dark/90 text-[15px] font-light">
        ...
        <div className="grid md:grid-cols-3 gap-7 md:gap-8 items-start">
          {/* NY State License */}
          <div className="text-center premium-card rounded-3xl p-8">
            <div
              className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-5 gold-gradient-icon"
            >
              <svg className="w-6 h-6 text-brand-dark/85" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-brand-dark/90 text-sm font-light mb-2">
              License #10991205323
            </p>
            <p className="text-brand-dark/65 text-[12px] font-light">
