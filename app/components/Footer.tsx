          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 text-sm">
            ...
            <div className="col-span-2 sm:col-span-2 md:col-span-1">
              ...
              <div className="flex gap-3 mt-3">
                ...
                <a href="https://www.youtube.com/@Mallan-NYC" target="_blank" rel="noopener noreferrer" aria-label="Subscribe on YouTube" className="text-gray-400 hover:text-brand-gold transition-colors">
