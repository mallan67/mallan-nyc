...
// reads "In Contract" (ActiveUnderContract never arrives as a status). These units come from the live feed, so the
// Mallan Off Market presence state never appears here.
