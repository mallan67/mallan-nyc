...
export default function AdjacentNeighborhoods({
  ...
  return (
    <section aria-label="Explore Nearby Neighborhoods" className="py-10 sm:py-14 bg-stone-50/50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {neighbors.map((n) => (
            <Link
              ...
              className="group block glass-card rounded-3xl overflow-hidden hover:shadow-md transition-shadow"
            >
              <div
