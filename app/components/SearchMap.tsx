          ...
          return (
            ...
            >
              <Popup maxWidth={280} minWidth={280} className="map-card-popup">
                <a href={listingHref(listing)} style={{ display: 'block', width: 280, textDecoration: 'none', color: 'inherit' }}>
                  {listing.media[0]?.url && (
                  ...
                  <div style={{ padding: '10px 14px 8px' }}>
                    ...
                    <div style={{ fontSize: 13, color: '#1a1a1a', marginTop: 6, fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 14px', borderTop: '1px solid #eee', background: '#fafafa' }}>
                    <span style={{ fontSize: 10, color: '#999', fontWeight: 600, letterSpacing: '0.5px' }}>
