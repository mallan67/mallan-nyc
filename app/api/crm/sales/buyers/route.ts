...
export async function POST(req: NextRequest) {
  ...
  const { first_name, last_name, email, phone, is_investor, entity_name, entity_type, pre_approved, pre_approved_amount, down_payment, available_funds, investment_strategy, notes } = body as Record<string, unknown>;
