...
| `RENTAL-FORM-REDESIGN.html` | **SUBMISSION** | Listing Agent | Agent creates/edits OWN exclusive rental listing → submits to RLS |
...
1. **REDESIGN = SUBMISSION** — listing agent creates/edits OWN exclusive listing for RLS
...
| 12 | Submission forms connected to RLS API | 4 | [ ] |
...
| `RENTAL-FORM-REDESIGN.html` | 6,988 | Rental Submission — listing agent → RLS |
