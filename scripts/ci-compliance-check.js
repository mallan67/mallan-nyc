...
const trestleFallbackEndpoints = [
  ...
  // Neon-quiet (2026-07-23): the buildings Trestle-fallback assembly (incl.
  // checkDistributionGates) moved verbatim into the shared cached module; the
  // route is a thin shell over it. The gate enforcement lives here now:
