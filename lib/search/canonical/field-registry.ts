...
export const FIELD_REGISTRY: readonly FieldSpec[] = Object.freeze([
  ...
  f({ canonicalKey: 'postal_code', liveEvidence: { probedAt: '2026-08-31', source: 'artifacts/section5f-executor-operator-probe-2026-08-31.json' }, notes: 'SECTION 5.F LIVE 2026-08-31. Operator, exclusion and compound proven. DATA NOTE: PostalCode is never null live (0 rows) but 215 rows carry 00000, so absence is encoded in band here too.', criterionRole: 'broker_input', workflows: ['sale', 'rental', 'building'], criterionValueShape: 'text', executionStrategy: 'provider_filter', searchParams: ['zip'], authorityResolution: 'by_listing_authority', authorityByListingKind: { mallanLocal: 'mallan_crm', providerListing: 'cotality' }, uiLabel: 'ZIP', category: 'address_location_building', type: 'string', providerMappingStatus: 'mapped', cotalityField: 'PostalCode', dbColumn: 'postal_code', searchParam: 'zip', visibility: V_PUBLIC, filterable: 'yes', reportable: 'yes' }),
