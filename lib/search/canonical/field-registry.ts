...
export interface FieldSpec {
   ...
   *
   *   list_price on a third-party listing   -> Cotality authored it
   ...
   *
   * So the registry declares the COTALITYLUTION MODE, and the envelope carries the
