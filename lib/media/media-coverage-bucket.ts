...
//
// READ-ONLY media-coverage bucketing for the media remediation packet
// (re-derived 2026-07-19 on post-#539 main; original packet 2026-07-16).
// Ownership matches the PR #539 media read path EXACTLY: both delegate to the
// canonical isMallanExclusiveListing helper — never a duplicated formula.
//
