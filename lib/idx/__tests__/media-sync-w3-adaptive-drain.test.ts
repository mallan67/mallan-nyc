...
describe("W3 — runMediaSync adaptive drain wiring", () => {
  ...
  it("required durable counters are present and mapped to physical outcomes", async () => {
    const rows = [
      { id: 1n, listing_id: "A", media_key: "K1", media_type: "Photo", order: 1, media_url_original: "u1", r2_key: null, media_url_cached: null, r2_attempts: null },
      { id: 2n, listing_id: "B", media_key: "K2", media_type: "Photo", order: 1, media_url_original: "u2", r2_key: null, media_url_cached: null, r2_attempts: null },
    ];
    let served = false;
