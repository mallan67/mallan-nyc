 ...
 * by the retired legacy media-backfill helper (`MAX_CONCURRENT = 5`).
 ...
 * and matches the proven-production legacy media cron that drained
 ...
 *     production pattern used by the retired legacy media-backfill helper,
 ...
 *     matching the retired legacy media-backfill helper's production pattern.
 *
...
export async function runMediaSync(options: RunMediaSyncOptions = {}): Promise<RunMediaSyncResult> {
  ...
  // Pattern matches the retired legacy media-backfill helper. Trestle's
