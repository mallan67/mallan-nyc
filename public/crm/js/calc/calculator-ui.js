...
var CrmCalcUI = (function () {
    ...
    var REGISTRY = {
        ...
        'rental-yield': {
            label: 'Rental Yield',
            group: 'Ownership & rental',
            run: function (i) { return CrmCalc.rentalYield(i); },
            seed: { propertyValue: 1500000, monthlyRent: 7500, annualExpenses: 24000 },
            headline: [['grossYieldPct', 'Gross yield', 'percent'], ['netYieldPct', 'Net yield', 'percent'], ['annualNetRent', 'Annual net rent']],
        },
        'break-even-price': {
            label: 'Break-Even Sale Price',
            group: 'Ownership & rental',
            run: function (i) { return CrmCalc.breakEvenSalePrice(i); },
            seed: { mortgagePayoff: 900000, commissionPct: 5, attorneyFee: 3000, otherCosts: 0, propertyType: 'condo' },
            headline: [['breakEvenPrice', 'Break-even sale price'], ['sellingCosts', 'Selling costs'], ['mortgagePayoff', 'Mortgage payoff']],
        },
        'carrying-cost': {
            label: 'Carrying Cost',
            group: 'Ownership & rental',
            run: function (i) { return CrmCalc.carryingCost(i); },
            seed: { monthlyMortgage: 6000, monthlyMaintenance: 2200, monthlyPropertyTax: 1400, monthlyInsurance: 200, monthlyUtilities: 300, monthlyOther: 0, months: 6 },
            headline: [['totalCost', 'Total over the period'], ['monthlyTotal', 'Per month'], ['dailyCost', 'Per day']],
        },
        'equity': {
            label: 'Equity',
            group: 'Ownership & rental',
            run: function (i) { return CrmCalc.equity(i); },
            seed: { marketValue: 2000000, mortgageBalance: 800000, otherLiens: 0, purchasePrice: 1400000 },
            headline: [['equity', 'Equity'], ['equityPct', 'Equity', 'percent'], ['cltvPct', 'Combined LTV', 'percent']],
        },
        'vacancy-cost': {
            label: 'Vacancy Cost',
            group: 'Ownership & rental',
            run: function (i) { return CrmCalc.vacancyCost(i); },
            seed: { monthlyRent: 6000, vacancyMonths: 2, monthlyMortgage: 3000, monthlyPropertyTax: 800, monthlyInsurance: 150, monthlyMaintenance: 250, marketingCosts: 1200, cleaningCosts: 600, paintingCosts: 900, repairCosts: 400 },
            headline: [['totalCost', 'Total cost of the vacancy'], ['lostRent', 'Lost rent'], ['equivalentMonthsOfRent', "Months' rent equivalent", 'percent']],
        },
        'exchange-1031': {
            label: '1031 Exchange',
            group: 'Investment',
