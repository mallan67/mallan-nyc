        function renderGridView() {
            try {
                ...
                cols.forEach(function(colId) {
                    ...
                    theadHTML += '<th class="px-2 py-1.5 text-left text-[10px] font-semibold text-gray-500 uppercase tracking-wide cursor-pointer hover:bg-gray-100 whitespace-nowrap select-none"' + (def.reso ? ' data-cotality-field="' + def.reso + '"' : '') + ' onclick="toggleColumnSort(\'' + colId + '\')">' + def.label + sortIcon + '</th>';
                });
