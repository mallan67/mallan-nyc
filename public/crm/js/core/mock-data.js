        ...
        var _MOCK_LISTINGS_DATA = [
            ...
            { id: 24, address: '220 RIVERSIDE BOULEVARD', unit: '19F', price: 1650000, totalMonthly: 2800, rooms: 5, beds: 2, baths: 2, fullBaths: 2, halfBaths: 0, reTaxes: 900, maintCC: 1900, intSqft: 1100, status: 'ACTIVE', ownership: 'Condominium', propertyType: 'Residential', propertySubType: 'Condominium', neighborhood: 'Upper West Side', borough: 'Manhattan', zip: '10069', era: 'New Construction', yearBuilt: 2005, buildingName: 'Trump Place', listingType: 'Exclusive', lid: '23830004', wid: '20095004', dom: 14, cdom: 14, listedDate: '01/31/2026', company: 'Compass', agentName: 'IDX Test Agent', photoCount: 11, latitude: 40.7770, longitude: -73.9890, description: 'IDX OPT-OUT TEST — IDX opted out but internet display ON (VOW-visible).', idxDisplayYN: false, internetDisplayYN: true, addressDisplayYN: true, permissions: { ownerOptOut: false, participantOnly: false, idxDisplay: false, syndication: false } },
