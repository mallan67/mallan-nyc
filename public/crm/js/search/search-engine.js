        ...
        function syncActiveViewToCanonical(tab, view) {
            ...
            Object.keys(CRITERION_VIEW_BINDINGS).forEach(function (key) {
                ...
                // An all-empty read is "not filtered", not "cleared elsewhere" —
                // it must not erase a value the OTHER view is holding, or opening
                // Advanced before it renders would wipe the Basic entry.
