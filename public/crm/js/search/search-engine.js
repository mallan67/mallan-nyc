        ...
        var CRITERION_ADAPTERS = {
            ...
            year_built: { kind: 'range', shape: 'range_number', ids: {
            ...
            units_total: { kind: 'range', shape: 'range_number', ids: {
            ...
            stories_total: { kind: 'range', shape: 'range_number', ids: {
            ...
            max_financing_percent: { kind: 'range', shape: 'range_number', ids: {
                ...
                rent:     { basic: ['rentalBuildingFinancingMin', 'rentalBuildingFinancingMax'], advanced: ['adv-financing', null] },
            ...
            public_remarks_keyword: { kind: 'text', shape: 'text', ids: {
                sale:     { basic: ['searchKeyword'], advanced: ['adv-keyword'] },
                rent:     { basic: ['searchKeyword'], advanced: ['adv-keyword'] },
                building: { basic: ['buildingKeywordSearch'], advanced: ['adv-keyword'] } } },
            ...
            building_name: { kind: 'text', shape: 'text', ids: {
                sale:     { basic: ['saleBuildingName'], advanced: ['adv-building-name'] },
                rent:     { basic: ['rentalBuildingName'], advanced: ['adv-building-name'] },
                building: { basic: ['buildingNameSearch'], advanced: ['adv-building-name'] } } },
            postal_code: { kind: 'text', shape: 'text', ids: {
                sale:     { basic: ['searchQuickZip'], advanced: ['adv-zip'] },
                rent:     { basic: ['searchQuickZip'], advanced: ['adv-zip'] },
                building: { basic: ['searchQuickZip'], advanced: ['adv-zip'] } } },
            unit: { kind: 'text', shape: 'text', ids: {
                sale:     { basic: ['searchQuickUnit'], advanced: ['adv-unit'] },
                rent:     { basic: ['searchQuickUnit'], advanced: ['adv-unit'] },
                building: { basic: ['searchQuickUnit'], advanced: ['adv-unit'] } } },
            listing_id_canonical: { kind: 'text', shape: 'text', ids: {
                sale:     { basic: ['searchQuickRLS'], advanced: ['adv-rls-id'] },
                rent:     { basic: ['searchQuickRLS'], advanced: ['adv-rls-id'] },
                building: { basic: ['searchQuickRLS'], advanced: ['adv-rls-id'] } } },
        ...
        function _readAdapter(key, adapter, tab, view) {
            if (adapter.kind === 'range' || adapter.kind === 'text') {
                var ids = ((adapter.ids || {})[tab] || {})[view] || [];
            ...
            if (adapter.kind === 'checkboxSet') {
                ...
                var boxes = scope.querySelectorAll('[data-field="' + adapter.field + '"]');
                if (!boxes.length) return undefined;
                var picked = [];
                scope.querySelectorAll('[data-field="' + adapter.field + '"]:checked').forEach(function (cb) {
        ...
        function _writeAdapter(key, adapter, tab, view, value) {
            ...
            if (adapter.kind === 'checkboxSet') {
                ...
                if (!scope) return;
                var wanted = value || [];
                scope.querySelectorAll('[data-field="' + adapter.field + '"]').forEach(function (cb) {
                    var v = cb.getAttribute('data-sub-status') || cb.getAttribute('data-value') || cb.value;
