        ...
        html += '<tr class="border-b hover:bg-gray-50 cursor-pointer" onclick="Router.navigate(\'/workspace/listing/' + E(lid) + '/overview\')">' +
          ...
          '<td class="px-3 py-2"><div class="flex gap-1" onclick="event.stopPropagation()">' +
            (l._fromPastDeals
              ...
              : '<button class="btn btn-sm btn-gold" onclick="openListingCampaign(\'' + E(l.listing_id || lid) + '\')" title="Create an investor / 1031 marketing email from this listing"><i class="fas fa-paper-plane mr-1"></i>Marketing Email</button>' +
