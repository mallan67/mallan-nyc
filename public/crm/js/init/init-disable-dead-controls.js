        ...
        (function () {
            ...
            var DEAD_CONTAINERS = [
                ...
                { selector: '#saleTransitExpand', reason: 'Transit search blocked by the PROVIDER, verified live 2026-09-01: $filter on Latitude returns HTTP 400 "Results from RLS has been suppressed (provider Level) as field Latitude cannot be used", and selected Latitude/Longitude come back null. Not a Mallan gap.' },
                { selector: '#rentalTransitExpand', reason: 'Transit search blocked by the PROVIDER, verified live 2026-09-01: $filter on Latitude returns HTTP 400 "Results from RLS has been suppressed (provider Level) as field Latitude cannot be used", and selected Latitude/Longitude come back null. Not a Mallan gap.' },
                { selector: '#buildingTransitExpand', reason: 'Transit search blocked by the PROVIDER, verified live 2026-09-01: $filter on Latitude returns HTTP 400 "Results from RLS has been suppressed (provider Level) as field Latitude cannot be used", and selected Latitude/Longitude come back null. Not a Mallan gap.' },
                { selector: '#advancedTransitExpand', reason: 'Transit search blocked by the PROVIDER, verified live 2026-09-01: $filter on Latitude returns HTTP 400 "Results from RLS has been suppressed (provider Level) as field Latitude cannot be used", and selected Latitude/Longitude come back null. Not a Mallan gap.' },
                ...
                { idAnchor: 'adv-grid-north', reason: 'Manhattan grid blocked by the PROVIDER, verified live 2026-09-01: same Latitude suppression as transit search (HTTP 400, field cannot be used). Not a Mallan gap.' },
                { idAnchor: 'bldg-grid-north', reason: 'Manhattan grid blocked by the PROVIDER, verified live 2026-09-01: same Latitude suppression as transit search (HTTP 400, field cannot be used). Not a Mallan gap.' },
                ...
                { selector: '#adv-dom-min', reason: 'Days on Market blocked by the PROVIDER, verified live 2026-09-01: both $filter (DaysOnMarket le 30) and $orderby return HTTP 400 "field DaysOnMarket cannot be used". Previously recorded as unproven; now proven.' },
                { selector: '#adv-dom-max', reason: 'Days on Market blocked by the PROVIDER, verified live 2026-09-01: both $filter (DaysOnMarket le 30) and $orderby return HTTP 400 "field DaysOnMarket cannot be used". Previously recorded as unproven; now proven.' },
