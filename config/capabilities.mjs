...
export const capabilities = [
  {
    ...
    program: 'P3',
    planRef: '§6 (Search architecture) [retargeted 2026-07-30; was §9.1, §9.7 of the retired master plan]',
    owner: 'unassigned',
    status: 'implemented',
    canonicalFiles: [
...

  {
    ...
    program: 'P1',
    planRef: '§4, C-2 (Provider contract architecture) [retargeted 2026-07-30; was §5.2, §5.3, §26 C-2 of the retired master plan]',
    owner: 'unassigned',
    status: 'implemented',
...

  {
    ...
    program: 'P1',
    planRef: '§13, §13.2 (Compliance and policy versioning) [retargeted 2026-07-30; was §6.2, §6.5 of the retired master plan]',
    owner: 'unassigned',
    status: 'implemented',
...

  {
    ...
    program: 'P1',
    planRef: '§7 (Media and R2 convergence) [retargeted 2026-07-30; was §15.1 of the retired master plan]',
    owner: 'unassigned',
    status: 'implemented',
...

  {
    ...
    program: 'P1',
    planRef: '§7, §13.4, C-6 (Media + AI-altered media provenance) [retargeted 2026-07-30; was §15.1, §17.5, §26 C-6 of the retired master plan]',
    owner: 'unassigned',
    status: 'discovered',
    canonicalFiles: [],
    tests: [],
...

  {
    ...
    program: 'P4',
    planRef: '§12, C-1 (Workflow, events, approvals, artifacts) [retargeted 2026-07-30; was §8.1, §26 C-1 of the retired master plan]',
    owner: 'unassigned',
    status: 'discovered',
    canonicalFiles: [],
    tests: [],
...

  {
    ...
    program: 'P4',
    planRef: '§12 (Workflow, events, approvals, artifacts) [retargeted 2026-07-30; was §8.2 of the retired master plan]',
    owner: 'unassigned',
    status: 'discovered',
    canonicalFiles: [],
    tests: [],
...

  {
    ...
    program: 'P1',
    planRef: '§13.1 (Compliance - reconstructable decisions) [retargeted 2026-07-30; was §6.1, §6.4 of the retired master plan]',
    owner: 'unassigned',
    status: 'discovered',
    canonicalFiles: [],
    tests: [],
...

  {
    ...
    program: 'P2',
    planRef: '§9 (Property identity) [retargeted 2026-07-30; was §7.4 of the retired master plan]',
    owner: 'unassigned',
    status: 'contracted',
...

  {
    ...
    program: 'P2',
    planRef: '§10 (Person, household, organization) [retargeted 2026-07-30; was §7.1, §7.2, §7.3 of the retired master plan]',
    owner: 'unassigned',
    status: 'discovered',
    canonicalFiles: [],
    tests: [],
...

  {
    ...
    program: 'P7',
    planRef: '§11 (CRM and portals) [retargeted 2026-07-30; was §13 of the retired master plan]',
    owner: 'unassigned',
    status: 'designed',
