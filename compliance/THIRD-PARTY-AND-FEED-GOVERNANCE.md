...
blankslate, blueroof360, BoomTown, CINC, Constellation RE, Home ASAP, HomeJunction, IDX (Elm Street), iHomefinder, kvCORE, Leadkit, Lofty, Luxury Presence, MoxiWorks, OLR, propertybase, PropMiX, RE Webmasters, RealGeeks, RealtyMX, Realtyna, RealtyWatch, RESoft, Sierra Interactive, Smarter Agent, The House Club, TREM Group, Xome, Ylopo

> **This enumeration is abridged: 29 of the 30 are named above.** One further
> REBNY-pre-licensed provider — a retired listing-entry platform that is no
> longer part of, or referenced by, the Mallan architecture — is intentionally
> not enumerated here. REBNY's own count of **30** is unchanged and is not
> disputed by this omission; only this document's list is shortened. Consult
> REBNY's published provider list if the full enumeration is needed.
