...
| Cron cadence (Cotality-aligned target) | 🟡 | 21 crons; idx-sync `*/30 * * * *`, media-sync `0 * * * *` — DRIFT from Cotality-aligned target (want Property `*/5 * * * *`, Media `*/15 * * * *`); restoration = COT-3. db-keepalive removed |
