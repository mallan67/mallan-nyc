...
> **Git branch:** `feat/t3-sponsor` · **Journal:** `ops/agent-journals/08-t3-sponsor.*` · **Index:** `docs/superpowers/plans/2026-05-30-CRM-ARCHITECTURE-MASTER-PLAN.md`
...
0. **RESUME FIRST.** `ops/agent-journals/08-t3-sponsor.state.json` + tail journal → resume after `last_completed_step`; append journal + update state each action; block → record, STOP, surface to Maya.
