...
> **Git branch:** `feat/t2-external-inventory` · **Journal:** `ops/agent-journals/05-t2-external.*` · **Index:** `docs/superpowers/plans/2026-05-30-CRM-ARCHITECTURE-MASTER-PLAN.md`
...
0. **RESUME FIRST.** `ops/agent-journals/05-t2-external.state.json` + tail journal → resume after `last_completed_step`; append journal + update state each action; block → record, STOP, surface to Maya.
