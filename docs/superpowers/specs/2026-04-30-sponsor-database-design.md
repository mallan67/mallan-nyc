...
REBNY RLS by structure carries only REBNY-member listings. Non-REBNY-member brokerages (e.g., Silverstein Collection LLC observed in external LMP screenshots) do not appear in RLS. Cross-MLS market sizing (web-search 2026-05-01):
