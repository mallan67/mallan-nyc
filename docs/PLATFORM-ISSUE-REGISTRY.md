...
| **6/10** | OPS-007/008/009/011/012/013, BIZ-006/007/008, PROD-004/005, BIZ-012 (OPS-006 retired from this row 2026-07-02 — Fixed/RW-004 with live baseline; BIZ-005 rescored 8/10 below after the live zero-count; **OPS-010 rescored 8/10 below after the 2026-07-25 live pg_stat**) | ✗ request · ✗ response · ✗ DB query result · ✗ live repro (static-complete: source, mechanism, environment, frequency N/A) |
| **8/10** | **OPS-010** — ✓ surface ✓ source ✓ DB query result (live read-only pg_stat 2026-07-25, PR #569: `sync_errors`=0; `audit_events` 89,867 append-only + 199→566/day; `listing_media` tombstones 28,664) ✓ environment (prod) ✓ timestamps ✓ mechanism · ✗ multi-day row-count trend series (single snapshot); ✗ request/response (N/A for a storage-growth issue) | close via retention + post-purge row-count trend |
