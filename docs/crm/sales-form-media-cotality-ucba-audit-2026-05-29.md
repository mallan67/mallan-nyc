...
> Generated 2026-05-29. **Audit only — no code, no PR.** Grounded in Cotality/IDX Plus normalized media rules (canonical) + REBNY UCBA advertising/display requirements. The legacy upstream intermediary is NOT treated as source of truth. No listing-identity/canonical-URL code touched. No SL-0004 rename. No Sentinel-L change (one future-detector recommendation noted in §9).
>
