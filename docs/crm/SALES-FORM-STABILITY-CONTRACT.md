...
Canonical server/public status: controls public display, IDX, Featured, Exclusives, the public URL.
```
...
10. Confirm the public URL panel shows the canonical URL only.
