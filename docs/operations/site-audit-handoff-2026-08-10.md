...
| **OPS-028** PHASE 4a has no reserved time slice | Phase 3 drain exit and Phase-4a entry share the same threshold, so a saturated drain skips the sweep by construction and the 14-day bound could be silently missed. Not occurring today (24h: time_budget_exhausted 0/144, backlog_remaining 0). **Registered, NOT accepted — awaiting Maya's disposition.** |
