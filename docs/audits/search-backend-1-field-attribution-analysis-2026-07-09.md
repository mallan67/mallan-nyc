...
> The §10 contract proposal and the §15.K 12-PR sequence below are **not** the plan of record. The only product/system authority is `MALLAN-PLATFORM-MASTER-PLAN.md` (repo root, canonical lineage PR #595 / `agent/publish-mallan-platform-master-plan-2026-08-04` — read §5 (Search), in particular §5.5 Search field contract, §5.6 Correct Search ordering and §5.19 Search acceptance, plus §6 (CMA) and §7 (Backend Listing Workspace) — before acting on anything here.
