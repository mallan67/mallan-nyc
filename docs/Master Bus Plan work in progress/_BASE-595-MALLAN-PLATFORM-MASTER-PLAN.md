...
>
> This is the frozen INPUT to Master Plan integration round 1 (the untouched #595 extract, 4,084 lines), kept as diff evidence. It is not the
...
>
> **Specifically dangerous here:** this snapshot's §5.1 is 42 lines and does **not** contain the decided
