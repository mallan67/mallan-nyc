...
| | |
|---|---|
| **Canonical** | `public/crm/SALE-FORM-REDESIGN.html` + `public/crm/RENTAL-FORM-REDESIGN.html` (CRM internal — actual RLS submission happens outside mallan.nyc); `lib/compliance/rls-enforcement.ts:assertRlsCompliantPayload` (write-time fail-closed gate) |
