...
// Building-Neon-wake (2026-07-23): the building-payload assembly (incl. the
// ACRIS merge + visibility contract) moved VERBATIM into the shared cached
// module — the route is a thin shell. Same contract, canonical location moved.
